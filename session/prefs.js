...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1729867282);
user_pref("app.update.lastUpdateTime.background-update-timer", 1729867282);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1729867282);
user_pref("app.update.lastUpdateTime.region-update-timer", 1729867282);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1729867282);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1729867312);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1729867282);
user_pref("app.update.migrated.updateDir3.A7C84650434C090B", true);
...
user_pref("browser.contextual-services.contextId", "{a6e5628b-4c5c-4c2d-af7a-51a131ec7fb9}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{bd6869f7-81d5-4521-b240-f092afa4a4aa}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20240904044952");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1729867353);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECI4N/li4vv20BAjYdxNLrTngYA==");
user_pref("extensions.formautofill.creditCards.supported", "off");
user_pref("extensions.getAddons.cache.enabled", false);
user_pref("extensions.installDistroAddons", false);
user_pref("extensions.lastAppBuildId", "20240904044952");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"01027547-dc0f-4fed-a62d-0dff36b60744\",\"pictureinpicture@mozilla.org\":\"7db5aa8f-e9fd-46c2-aff5-c33de7a6e1e2\",\"screenshots@mozilla.org\":\"72299683-7b08-4c47-b145-cf4596d528b2\",\"webcompat-reporter@mozilla.org\":\"55f11528-e053-41ba-b6cd-464b2d37d1f9\",\"webcompat@mozilla.org\":\"aa27d793-ed9f-4f31-8f4d-7166bca1e657\",\"default-theme@mozilla.org\":\"dfe88a6b-c955-47ec-843e-8488d9dc3af4\",\"addons-search-detection@mozilla.com\":\"c7ce81b0-3336-49fd-a51c-e756db71c684\"}");
...
user_pref("sanity-test.version", "20240904044952");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECNXBH4UykQh7BAhi4pciSOCPiA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1729867351);
...
user_pref("toolkit.telemetry.previousBuildID", "20240904044952");
