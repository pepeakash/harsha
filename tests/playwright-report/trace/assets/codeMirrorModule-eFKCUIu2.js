import { p as bu, q as ku } from "./workbench-D0cirtfA.js";
var ya = { exports: {} };
(function (jt, Jt) {
  (function (F, Pe) {
    jt.exports = Pe();
...
`
      ...
      return (
        t.cache.hasOwnProperty(o)
          ...
          : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
            t.hasHeights || (Va(e, t.view, t.rect), (t.hasHeights = !0)),
            (l = ts(e, t, n, r)),
            l.bogus || (t.cache[o] = l)),
        {
          left: l.left,
        ...
        for (var h = 0; h < 4; h++) {
          ...
          if (
            (k && ee < 9 && l == 0 && a == i.coverEnd - i.coverStart
              ...
              : (u = es(w(o, l, a).getClientRects(), r)),
            u.left || u.right || l == 0)
          )
            break;
          (a = l), (l = l - 1), (s = "right");
        }
        k && ee < 11 && (u = rs(e.display.measure, u));
      } else {
        l > 0 && (s = r = "right");
        var v;
    ...
    function Ni(e, t, n) {
      ...
      for (var l = ae(r, i); ; ) {
        var a = ns(e, l, i, t, n),
          s = Ea(l, a.ch + (a.xRel > 0 || a.outside > 0 ? 1 : 0));
        if (!s) return a;
        var u = s.find(1);
    ...
    function ns(e, t, n, r, i) {
      ...
      if (h) {
        var v = (e.options.lineWrapping ? os : is)(e, t, n, o, h, r, i);
        (u = v.level != 1),
          (a = u ? v.from : v.to - 1),
          (s = u ? v.to : v.from - 1);
      }
    ...
    function kn(e, t) {
      e.doc.highlightFrontier < e.display.viewTo &&
        e.state.highlight.set(t, oe(xs, e));
    }
    function xs(e) {
      var t = e.doc;
    ...
    function Ns(e, t) {
      var n = t["spans_" + e.id];
      if (!n) return null;
      for (var r = [], i = 0; i < t.text.length; ++i) r.push(Es(n[i]));
      return r;
    }
    function wl(e, t) {
      var n = Ns(e, t),
    ...
    (kt.prototype = M(Dn.prototype, {
      ...
      replaceSelections: at(function (e, t, n) {
        ...
        for (
          var a = t && t != "end" && Cs(this, r, t), s = r.length - 1;
          s >= 0;
          s--
        )
          Jr(this, r[s]);
      ...
      unlinkDoc: function (e) {
        if ((e instanceof Ge && (e = e.doc), this.linked))
          for (var t = 0; t < this.linked.length; ++t) {
            var n = this.linked[t];
            if (n.doc == e) {
              this.linked.splice(t, 1), e.unlinkDoc(this), Ws(_l(this));
              break;
            }
          }
    ...
    function Xs(e) {
      ...
      for (var n in e)
        if (e.hasOwnProperty(n)) {
          ...
          for (var i = Oe(n.split(" "), Gs), o = 0; o < i.length; o++) {
            var l = void 0,
              a = void 0;
            o == i.length - 1
              ? ((a = i.join(" ")), (l = r))
...
`,
    ...
    io.prototype.compare = function (e, t, n) {
      return this.time + eu > e && X(t, this.pos) == 0 && n == this.button;
    };
    var Pn, In;
    function tu(e, t) {
      var n = +new Date();
      ...
      function b(j) {
        if (X(v, j) != 0)
          if (((v = j), r.unit == "rectangle")) {
            ...
            (Qe[a] = au(e, new He(Le(o, nt), rt))), pt(o, Rt(e, Qe, a), ct);
          }
      }
...
`) &&
    ...
    function uo(e, t, n, r, i) {
      ...
      function h(Z) {
        ...
        } else i ? (j = Ys(e.cm, a, t, n)) : (j = to(a, t, n));
        if (j == null)
...
`) > -1
    ...
    uu(Ge), hu(Ge);
    var xu = "iter insert remove copy getEditor constructor".split(" ");
  ...
  (function (F) {
    ...
    F.defineMode("css", function (le, W) {
      ...
      function Ee(T, z) {
        ...
        if (M == "@") return T.eatWhile(/[\w\\\-]/), te("def", T.current());
        if (M == "=" || ((M == "~" || M == "|") && T.eat("=")))
          return te(null, "compare");
        if (M == '"' || M == "'") return (z.tokenize = qe(M)), z.tokenize(T, z);
        if (M == "#") return T.eatWhile(/[\w\\\-]/), te("atom", "hash");
        if (M == "!") return T.match(/^\s*\w*/), te("keyword", "important");
      ...
      return (
        (Oe.top = function (T, z, M) {
          ...
          if (oe && /@component/i.test(T)) return Ne(M, z, "atComponentBlock");
          if (/^@(-moz-)?document$/i.test(T)) return Ne(M, z, "documentTypes");
        ...
        (Oe.at = function (T, z, M) {
          return T == ";"
            ...
            : T == "{" || T == "}"
              ? et(T, z, M)
              : (T == "word" ? (xe = "tag") : T == "hash" && (xe = "builtin"),
                "at");
        }),
            ...
            return (
              ...
              M.prev &&
                ...
                (M.type == "block" ||
                  ...
                  : ((Ie == ")" &&
                      (M.type == "parens" || M.type == "atBlock_parens")) ||
                      (Ie == "{" && (M.type == "at" || M.type == "atBlock"))) &&
